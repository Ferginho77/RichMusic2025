<div class="modal fade" id="HotnewsModal" tabindex="-1" aria-labelledby="HotnewsModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="HotnewsModalLabel">Artikel Event</h5>
